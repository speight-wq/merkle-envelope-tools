...
const MAINNET_TEST_VECTORS = {
  ...
  vector3: {
    ...
    // Block 170 has 2 transactions, so merkle root != coinbase txid
    // Merkle tree: hash(tx0 || tx1) = merkle_root
    // tx0 (coinbase): b1fea52486ce0c62bb442b530a3f0132b826c74e473d1f2c220bfa78111c5082
    // tx1 (Satoshi->Hal): f4184fc596403b9d638783cf57adfe4c75c605f6356fbc91338530e9831e9e16
    // Sibling hash must be in INTERNAL byte order (reversed from display)
    merkleProof: [
...
const INVALID_TEST_VECTORS = {
  ...
  invalidMerkleProof: {
    ...
    // One byte changed in branch hash (internal byte order)
    merkleProof: [
